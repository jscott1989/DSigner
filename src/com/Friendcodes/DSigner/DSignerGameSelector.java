 ...
 */
public class DSignerGameSelector extends JComboBox{
    
	private static final long serialVersionUID = 8252068356853741671L;

	/** Creates a new instance of DSignerGameSelector */
    public DSignerGameSelector() 
    {
        ...
        addActionListener(new ActionListener(){
           ...
           {
               DSigner.GameSelected(getSelectedIndex());
           }
        });
    }
